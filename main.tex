...
\subsection{Research}
\cventry{May--Jul 2017}{Research Internship, \emph{\small visiting Antonios Antoniadis}}{Max Planck Institut for Informatics}{Saarbrücken, Germany}{}{Funded by MPII-UChile Collaborative Grant CONICYT: Fast Approximation Algo. for Massive Data Sets.}

\cventry{Spring 2015}{Research Assistant, \emph{\small under supervision of Francisco Förster}}{Center for Mathematical Modeling, FCFM Universidad de Chile
}{Santiago, Chile}{}{In the Astroinformatics Lab. on problem 'Multiobjective Optimization for Scheduling of the LSST'.}



\subsection{Teaching Assistance}
\cventry{Spring 2017}{Stochastic Models for Engineering Systems, \emph{\small with Prof. Jos\'e Rafael Correa}}{Department of Industrial Engineering - Universidad de Chile}{}{}{}
...
\cvitem{}{\textbf{A Near Optimal Mechanism for Energy Aware Scheduling} (with A. Antoniadis) \emph{Submitted to conference: International Colloquium on Automata, Languages, and Programming (ICALP)}}
\cvitem{}{\textbf{SUPERSET: A (Super)Natural Variant of the Card Game SET} (with F. Botler, R. Hoeksma, K. Schewior and A. Tönnis) \emph{Submitted to conference: International Conference on Fun with Algorithms (FUN)}}

...
\cventry{Mayo--Julio 2017}{Pasantía de Investigación, \emph{\small visita a Antonios Antoniadis}}{Max Planck Institut for Informatics}{Saarbrücken, Alemania}{}{Financiado por el proyecto de colaboración MPII-UChile de CONICYT: Fast Approximation Algo. for Massive Data Sets.}
...
\cvitem{}{\textbf{SUPERSET: A (Super)Natural Variant of the Card Game SET} (con F. Botler, R. Hoeksma, K. Schewior and A. Tönnis) \emph{Aceptada en conferencia: International Conference on Fun with Algorithms (FUN)}}

\section{Trabajo en progreso}
\cvitem{}{\textbf{A Near Optimal Mechanism for Energy Aware Scheduling} (con A. Antoniadis) \emph{Enviada a conferencia: International Symposium on Algorithmic Game Theory (SAGT)}}
